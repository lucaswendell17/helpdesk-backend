...
public class DBService {
	...
	public void instaciaDB() {
		Tecnico tec1 = new Tecnico(null, "Lucas Wendel", "43957777836", "lucas@email.com", encoder.encode("123"));
		tec1.addPerfil(Perfil.ADMIN);
		
		Cliente cli9 = new Cliente(null, "Linus Torvalds", "28363394629", "torvalds@email.com", encoder.encode("123"));
		...
		pessoaRepository.saveAll(Arrays.asList(tec1, tec2, tec3, tec4, tec5, cli1, cli2, cli3, cli4, cli5, cli9));
